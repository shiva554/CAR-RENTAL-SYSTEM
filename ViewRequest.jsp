...
<!--		<li><a href="ViewBooked.jsp">View Booked Car</a></li> -->
  ...
  <td>
     ...
     <tr><th>User Name</th><th>Contact No</th><th>Booking Date</th><th>Source</th><th>Destination</th><th>Number of Persons</th></tr>
	 <%
	 java.util.Date d1 = new java.util.Date();
	 java.sql.Date end = new java.sql.Date(d1.getTime());
	 Connection con = Database.getCon();
	 Statement stmt = con.createStatement();
	 ResultSet rs = stmt.executeQuery("select * from book_car where total_rent=0");
	 while(rs.next()){
