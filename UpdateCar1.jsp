...
<%
	String car_no=request.getParameter("t6");
	 ...
	 ResultSet rs = stmt.executeQuery("select * from addcar where car_no='"+car_no+"'");
	 while(rs.next()){
...
<td><input type="text" name="seating" value="<%=rs.getString(4)%>"></td>
</tr>

<tr>
<td>Owner Contact No</td>
<td><input type="text" name="t4" value="<%=rs.getString(5)%>"></td>
</tr>

<tr>
<td>Owner Address</td>
<td><input type="text" name="t5" value="<%=rs.getString(6)%>"></td>
</tr>
